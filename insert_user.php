...
include("includes/connection.php");
	...
	if(isset($_POST['sign_up'])){
		...
		values('$first_name','$last_name','$username','Hey there! I am using Social.ly.','...','$pass','$email','$country','$gender','$birthday','$profile_pic','default_cover.jpg',NOW(),'$status','$posts','Iwanttoputading intheuniverse.')";
